...
<div class="container">
	<div class="page-hero">
      <div>
        <div class="hero-title">내가 남긴 글들을 한눈에 모아봤어요</div>
        <div class="hero-desc">작성한 게시글을 다시 확인하고, 원하는 글로 바로 들어가보세요.</div>
      </div>
      <div class="hero-pill">✏️ 내 글 모아보기</div>
    </div>
    ...
    <div id="loading" class="loading-text" style="display:none;">게시글 불러오는 중...</div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let offset = 3;   // 처음 3개는 이미 JSP에서 렌더링됨
    const size = 3;
    let isLoading = false;
    let hasNext = true;
    ...
    function loadMoreBoards() {
        ...
        $.ajax({
            url: "${path}/board/myboardlist/more",
            type: "GET",
            data: {
                offset: offset,
                size: size
